...
class _BotCommands:
    def __init__(self):
        self.FfmpegCommand = f'ffmpeg{CMD_INDEX}'
        self.MkvmergeCommand = f'mkvmerge{CMD_INDEX}'
        self.MediainfoCommand = f'mediainfo{CMD_INDEX}'
        self.LsCommand = f'ls{CMD_INDEX}'
        self.RmCommand = f'rm{CMD_INDEX}'
        self.MvCommand = f'mv{CMD_INDEX}'
        self.CpCommand = f'cp{CMD_INDEX}'
        self.MkvextractCommand = f'mkvextract{CMD_INDEX}'
        self.EchoCommand = f'echo{CMD_INDEX}'
        self.CurlCommand = f'curl{CMD_INDEX}'
        self.MkdirCommand = f'mkdir{CMD_INDEX}'
        self.YtdlpCommand = f'ytdlp{CMD_INDEX}'
        self.Python3Command = f'python3{CMD_INDEX}'
        self.RunCommand = f'r{CMD_INDEX}'
        self.ChandCommand = f'c{CMD_INDEX}'
        self.UpCommand = f'up{CMD_INDEX}'
        self.DlCommand = f'dl{CMD_INDEX}'
        self.GCommand = f'g{CMD_INDEX}'
        self.InScrCommand = f'ix{CMD_INDEX}'
        self.MInfoCommand = f'mi{CMD_INDEX}'
        self.BypassCommand = f'by{CMD_INDEX}'
        self.ClonesCommand = f'clo{CMD_INDEX}'
        self.PaheCommand = f'pahe{CMD_INDEX}'
        self.PsaCommand = f'psa{CMD_INDEX}'
